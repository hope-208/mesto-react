...
Сервис Mesto является интерактивной страницей, выполненной с использованием [React](https://github.com/facebook/create-react-app), куда можно добавлять фотографии, удалять их и ставить лайки. Ссылка: https://hope-208.github.io/mesto/.
